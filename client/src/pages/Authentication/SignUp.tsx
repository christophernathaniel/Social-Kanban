...
import NoUiLayout from '../../layout/NoUiLayout';
...
const SignUp: React.FC = () => {
        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data.email) {
              ...
              setTheError(
                {
                  message: `Welcome, ${res.data.name}. You are logged in successfully using Google. Please finish setting up your account.`,
                  type: "success",
                },
              );
            } else {
              ...
              setTheError(
                {
                  message: "An error with your Google credentials",
                  type: "failure",
                },
              );
            }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (profile.name ?? name) {
      ...
      setTheError(
        {
          message: "Please enter all credentials to continue",
          type: "failure",
        }
      );
      return;
    ...
    try {
      ...
      if (error.response.data.type == 'username') {
        setTheError(
          {
            message: "Your username is not unique. Please try another one",
            type: "failure",
          }
        );
      } else {
        setTheError(
          {
            message: "Your account creation has failed. Please try again",
            type: "failure",
          }
        );
      }
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {theError.message && (
                <div className="mb-6">
                  <span className={theError.type === 'success' ? 'text-green-500' : 'text-red-500'}>{theError.message}</span>
                </div>
              )}
              <span className="mb-1.5 block font-medium">Start for free</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to NebulaAdmin
              </h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-secondary bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                    <span className="mt-1 block font-medium text-sm">* This is how other users on the platform will identify you</span>
                ...
                {!passwordView && (<div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                    Name
                  </label>
                  <div className="relative">
                ...
                {!passwordView && (<button onClick={() => gLogin()} className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
