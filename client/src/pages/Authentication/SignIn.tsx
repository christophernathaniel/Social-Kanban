        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data.email) {
              ...
              setTheError(
                {
                  message: `Welcome, ${res.data.name}. You are logged in successfully using Google.`,
                  type: "success",
                },
              );
            } else {
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <span className="mb-1.5 block font-medium">
                {!passwordView && (<>Start for free</>)}
                {passwordView && (<>Enter your NebulaAdmin password</>)}
              </span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                {passwordView && (<>Sign In to NebulaAdmin</>)}
                {!passwordView && (<>Enter your account password</>)}
              </h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {!passwordView && (<>
                  <a onClick={() => gLogin()} className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                    <span>
                      <svg
                        width="20"
                        height="20"
